...
async def start(client, message):
    ...
    if mc.startswith('verify'):
        ...
        await message.reply(f"✅ 𝗬𝗼𝘂 𝘀𝘂𝗰𝗰𝗲𝘀𝘀𝗳𝘂𝗹𝗹𝘆 𝘃𝗲𝗿𝗶𝗳𝗶𝗲𝗱 𝘂𝗻𝘁𝗶𝗹: {get_readable_time(VERIFY_EXPIRE)}", reply_markup=reply_markup, protect_content=False)
        return
    ...
    if not await db.has_premium_access(message.from_user.id):
        if IS_VERIFY and not verify_status['is_verified']:
            ...
            await message.reply("𝗬𝗼𝘂 𝗻𝗼𝘁 𝘃𝗲𝗿𝗶𝗳𝗶𝗲𝗱 𝘁𝗼𝗱𝗮𝘆! 𝗞𝗶𝗻𝗱𝗹𝘆 𝘃𝗲𝗿𝗶𝗳𝘆 𝗻𝗼𝘄. 🔐", reply_markup=InlineKeyboardMarkup(btn), protect_content=False)
            return
    else:
        pass
    ...
    if mc.startswith('all'):
        ...
        for file in files:
            ...
            if settings.get('is_stream', IS_STREAM):
                btn = [[
                    InlineKeyboardButton("𝗪𝗮𝘁𝗰𝗵 & 𝗗𝗼𝘄𝗻𝗹𝗼𝗮𝗱", callback_data=f"stream#{file.file_id}")
                ],[
                    InlineKeyboardButton('⚡️ 𝗨𝗽𝗱𝗮𝘁𝗲𝘀 𝗖𝗵𝗮𝗻𝗻𝗲𝗹 ⚡️', url=UPDATES_LINK),
                    InlineKeyboardButton('💡 𝗦𝘂𝗽𝗽𝗼𝗿𝘁 𝗚𝗿𝗼𝘂𝗽 💡', url=SUPPORT_LINK)
                ],[
    ...
    if settings.get('is_stream', IS_STREAM):
        btn = [[
            InlineKeyboardButton("𝗪𝗮𝘁𝗰𝗵 & 𝗗𝗼𝘄𝗻𝗹𝗼𝗮𝗱", callback_data=f"stream#{file_id}")
        ],[
            InlineKeyboardButton('⚡️ 𝗨𝗽𝗱𝗮𝘁𝗲𝘀 𝗖𝗵𝗮𝗻𝗻𝗲𝗹 ⚡️', url=UPDATES_LINK),
            InlineKeyboardButton('💡 𝗦𝘂𝗽𝗽𝗼𝗿𝘁 𝗚𝗿𝗼𝘂𝗽 💡', url=SUPPORT_LINK)
        ],[
...
async def plans_cmd_handler(client, message):                
    ...
    await message.reply_photo(
        photo=PAYMENT_QR,
        caption="**● 𝗣𝗿𝗲𝗺𝗶𝘂𝗺 𝗳𝗲𝗮𝘁𝘂𝗿𝗲𝘀! 𝟭. 𝗡𝗼 𝗻𝗲𝗲𝗱 𝘁𝗼 𝘃𝗲𝗿𝗶𝗳𝘆. 𝟮. 𝗡𝗼 𝗻𝗲𝗲𝗱 𝘁𝗼 𝘄𝗮𝘁𝗰𝗵 𝗮𝗱𝘀, 𝗰𝗼𝗺𝗽𝗹𝗲𝘁𝗲𝗹𝘆 𝗮𝗱 𝗳𝗿𝗲𝗲 𝗲𝘅𝗽𝗲𝗿𝗶𝗲𝗻𝗰𝗲. 𝟯. 𝗚𝗲𝘁 𝗨𝗻𝗹𝗶𝗺𝗶𝘁𝗲𝗱 𝗺𝗼𝘃𝗶𝗲𝘀 𝗮𝗻𝗱 𝘀𝗲𝗿𝗶𝗲𝘀 𝗱𝗶𝗿𝗲𝗰𝘁𝗹𝘆 𝗶𝗻 𝗳𝗶𝗹𝗲𝘀 𝗮𝗻𝗱 𝘃𝗶𝗱𝗲𝗼𝘀 𝗳𝗼𝗿𝗺𝗮𝘁.",
        reply_markup=reply_markup
    )
